...
localStorage.setItem('contrasena', 'admin2025');

window.addEventListener("DOMContentLoaded", () => {
    const usuario = document.getElementById('admin');
            ...
            <div class="first">
                ...
                <div class="login-container">
                    <form id="loginForm">
                        ...
                        <div class="boton">
                            <button class="signin" type="submit"><a href="./pages/inicioadmin.html">SIGN IN<a></button>
                        </div>
                    </form>
                </div>
            </div>
